...
def main(args):
    if len(args) == 1:  # ARINC424 -> Lon, Lat
        ...
        if coordinates is not None:
            ...
            return 'Input is not ARINC424 code for full degrees.'
        ...
        if Arinc424CoordinatesConversion.is_longitude_dmh(lon) and Arinc424CoordinatesConversion.is_latitude_dmh(lat):
            ...
            return arinc424_code
        else:
            return 'Input coordinates must be full degrees in DMH format, example: 12200E.'

    else:
        usage_msg = 'Usage if you want to convert from ARINC424 code to Longitude and latitude:\n' \
